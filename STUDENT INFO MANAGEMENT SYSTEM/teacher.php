...
<br>
<p id = "dashboardt">DASHBOARD OF (<?php echo $_SESSION['assignsection'];?>)</p>
<br>
<div class = "alldash">
	<div id = "total-st">
	
	<h3 id = "tns">36</h3>
	<p id = "tts">Total Student</p>
	<div id = "btts"></div>
	<p id = "ttsinfo"><a href = "" style = "text-decoration: none; color: white;">More Info</a></p>
	
	</div>
	<div id = "total-male">
	<h3 id = "tnm">24</h3>
	<p id = "ttm">Total Male</p>
	<div id = "bttm"></div>
	<p id = "ttminfo"><a href = "" style = "text-decoration: none; color: white;">More Info</a></p>
	
	
	</div>
	<div id = "total-female">
	<h3 id = "tnf">12</h3>
	<p id = "ttf">Total Female</p>
	<div id = "bttf"></div>
	<p id = "ttfinfo"><a href = "" style = "text-decoration: none; color: white;">More Info</a></p>
